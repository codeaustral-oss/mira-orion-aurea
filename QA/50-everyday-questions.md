...
In the simulator, open the chat's **•••** menu and choose **Add 50 chats**. Mira saves these as separate conversations under **Conversations**, with plain question titles and no numeric prefixes. Opening the menu again offers **Open 50 chats** without duplicating them. Most answers are prepared in isolated profile storage. Shopping searches and the split are run when their chat is opened, so product listings are current and split actions have saved state.
...
36. Buy cat food — opens a live shopping task with product picks and a Choose action.
37. Purchase headphones — opens a live shopping task with product picks and a Choose action.
38. Buy a book — opens a live shopping task with product picks and a Choose action.
39. Buy running shoes — opens a live shopping task with product picks and a Choose action.
